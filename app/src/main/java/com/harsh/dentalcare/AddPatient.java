...
public class AddPatient extends AppCompatActivity {
    ...
    TextInputEditText mobileInput,emailInput,adderssInput,referInput;
    RadioGroup genderInput;
    MaterialButton savebtn;
    ArrayList<Long>patientRegs=new ArrayList<>();
    @Override
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ageInput=findViewById(R.id.patient_age_input);
        ...
        referInput=findViewById(R.id.refer_input);
        savebtn=findViewById(R.id.save_button);

        final SharedPreferences preferences=getSharedPreferences("myprefs",MODE_PRIVATE);
        String lastreg=preferences.getString("lastpreg",null);
        if (lastreg!=null){
        ...
        patientRegs=dbHelper.getPatientRegs();
        savebtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String reg=registrationInput.getText().toString();
                if (patientRegs.contains(Long.parseLong(reg))) {
                ...
                if (nm.isEmpty()) {
                    ((TextInputLayout) findViewById(R.id.patient_name_input_layout)).setError("Enter Name");
                    nameInput.requestFocus();
                    return;
                }
                ...
                String ref=referInput.getText().toString();
                dbHelper.addPatient(Long.parseLong(reg),nm,gndr,age,mob,em,ad,ref);
                preferences.edit().putString("lastpreg",reg).apply();
                Intent intent=new Intent();
                intent.setData(Uri.parse("New Patient Data Saved!"));
